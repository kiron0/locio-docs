...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/kiron0/locio

features:
  - icon: 📊
    title: Rich statistics
    details: Get detailed breakdowns by file extension, directory, and more.
  - icon: 📁
    title: Smart file discovery
    details: Recursively scan directories while ignoring binaries and unwanted paths.
  - icon: 🎯
